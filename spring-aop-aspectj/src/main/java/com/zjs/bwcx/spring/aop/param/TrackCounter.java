...
public class TrackCounter {
	...
	@Pointcut("execution(* com.zjs.bwcx.spring.aop.param.CompactDisc.playTrack(Integer)) && args(trackNumber)")
	...
	@Before("execution(* com.zjs.bwcx.spring.aop.param.CompactDisc.play())")
	public void test2() {
