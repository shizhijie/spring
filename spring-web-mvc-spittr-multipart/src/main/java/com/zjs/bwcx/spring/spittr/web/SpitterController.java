...
public class SpitterController {
	...
	public String processRegistration(MultipartFile profilePicture, @Valid Spitter spitter, Errors errors,HttpServletRequest rqRequest)
			throws IOException {
		...
		String path = rqRequest.getSession().getServletContext().getRealPath("/")+"/data/spittr/" + new Date().getTime() + profilePicture.getOriginalFilename();
